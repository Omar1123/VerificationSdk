package com.company.jak.faceverification.gui;
...
import com.company.jak.faceverification.R;
...
public class EnrollmentDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.enroll_layout, null);
        ...
        builder.setTitle(R.string.msg_enter_user_id);
